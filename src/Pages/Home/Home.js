...
const Home = () => {
  ...
  return (
    <div>
      <div className="lg:relative bg-purple-400">
        <div className="lg:absolute hidden lg:block inset-x-0 bottom-0">
          <svg
            viewBox="0 0 224 12"
            fill="currentColor"
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="lg:relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            <h1 className="mb-6 lg:text-3xl tracking-tight text-rose-700 text-3xl text-center ">
